...
use crate::{output::Output, rand::rand_string, ui::wgui::model::OutputContent};
...
impl OutputDevice {
    pub async fn construct(
        ...
        win: Res<MtoolWindow>,
    ) -> Result<Res<crate::output::OutputDevice>, anyhow::Error> {
        ...
        Ok(Res::new(crate::output::OutputDevice(self_)))
    }
}
