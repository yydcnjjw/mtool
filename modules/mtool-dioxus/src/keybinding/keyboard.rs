use dioxus_desktop::winit::keyboard::{KeyCode as WinitKeyCode, PhysicalKey as WinitPhysicalKey};
use mapp::keyboard_types::Code as KeyCode;

pub fn from_winit_physical_key(key: &WinitPhysicalKey) -> Option<KeyCode> {
    match key {
