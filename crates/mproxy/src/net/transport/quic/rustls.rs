...
use quinn_proto::{
    crypto::{self, CryptoError, HeaderKey, KeyPair, Keys, UnsupportedVersion},
...
use rustls::{
    self,
    quic::{Connection, HeaderProtectionKey, KeyChange, PacketKey, Secrets, Version, Algorithm}, Tls13CipherSuite,
};
...
impl<T> crypto::HeaderKey for T
where
    T: HeaderProtectionKey,
{
